...
// Light2.add(pointLight2.position, "y").min(-10).max(3).step(0.01);
...
// Light3.add(pointLight3.position, "y").min(-10).max(3).step(0.01);
...
const updateSpehere = (event) => {
  sphere.position.y = window.scrollY * 0.001;
};

window.addEventListener("scroll", updateSpehere);
